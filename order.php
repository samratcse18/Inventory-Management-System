		...
		<div class="col-lg-12">
			...
			<div class="panel panel-default">
                <div class="panel-heading">
                	<div class="row">
                    	<div class="col-lg-5 col-md-10 col-sm-8 col-xs-6">
                            <h3 class="panel-title">Order List</h3>
                        </div>
						<div class="col-lg-5 col-md-10 col-sm-8 col-xs-6">
							<input type="search" id="filterInput" placeholder="Enter Customer Name">
...
<script>
	...
	$(document).ready(function(){
		loadorder();
		function loadorder(){
			var inventory_order_name = $("#filterInput").val();
			$.ajax({
				url: 'order_fetch.php',
				type: 'POST',
				data: { inventory_order_name: inventory_order_name },
				success: function(response){
					$('#product_order_data').html(response);
				},
		...
		$("#filterInput").on("input", loadorder);
	...
	function add_product_row(count = '')
		...
		$(document).on('click', '.update', function(){
			...
			console.log(inventory_order_id);
			$.ajax({
